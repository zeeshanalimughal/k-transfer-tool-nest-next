...
function ServiceCard({ service, id }: { service: IService, id: number }) {
    return (
        <div className={cn("p-6 text-center flex flex-col items-center justify-center lg:border-b-2 lg:border-r-2", [3, 6, 9, 12].includes(id) ? "lg:border-r-0" : "", [10, 11, 12].includes(id) ? "lg:border-b-0" : "")}>
